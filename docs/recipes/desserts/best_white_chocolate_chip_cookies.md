...
7. Drop tablespoon-sized amount onto un-greased baking sheets (I use a small cookie scoop to help make it easier)
8. Bake 9 to 11 minutes or until golden brown
9. Cool on baking sheets for two minutes before removing and placing on wire racks to cool.

...
3. Using a potato masher add the salt, cumin, and cayenne and mash, then fold in the onions, tomatoes, cilantro, and garlic.
4. Add 1 Tbsp of the reserved lime juice.
